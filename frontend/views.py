...
def blog_list(request):
    ...
    # pages = Blogs.objects.all().values()
...
def page_detail(request,slug='home'):
    ...
    # if page_obj:
    # return JsonResponse({'content': page_obj.content})
    return HttpResponse(page_obj.content, content_type="text/html")
    return HttpResponse(page_obj.content, content_type="text/plain")
    # else:
        # raise Http404
